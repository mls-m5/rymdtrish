...
class Draw{
 ...
 public:
  ...
  static void drawStars(){
    //Always seeds the random generator with the same number so the stars stay in the same place
    long rnd;
    rnd = rand();
    srand(20);
    glPointSize(1);
...
#define PARA double x, double y, double a, double r = 1, double g = 1, double b = 1, double scale = 1
